  ...
  return (
    <div className='w-full bg-slate-800'>
      ...
      <motion.div
        ...
        viewport={{ once: true }}
      >
        <div className="flex flex-col md:flex-row justify-center items-center pv-24 pb-24 gap-14">
          <Card
            key={0}
            title="Flyq.no"
            image="flyq.jpg"
              ...
              <div className='flex flex-col lg:flex-row p-12 justify-center align-center gap-12'>
                ...
                <div className='flex flex-col lg:w-1/2 w-full'>
                  <div className='flex flex-row gap-2'>
                    ...
                    <h2 className={`font-semibold text-sm self-center pb-2 ${information.finished ? 'text-lime-500' : 'text-amber-400'
                      }`}>
